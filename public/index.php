<?php
//echo "<h1>This is a get</h1>";
//var_dump($_GET);
//echo "<h1>This is a post</h1>";
//var_dump($_POST);

//if (isset($_GET["name"])) {
//	echo $_GET["name"] . " is awesome!";
//}
?>
...
<?php
if(isset($_POST["destination"]) && isset($_POST["start-date"]) && isset($_POST["end-date"])) {
	echo "You're traveling to ".$_POST["destination"]." from ".$_POST["start-date"]." to ".$_POST["end-date"].", have fun!";
} else { ?>
